...
namespace openPMD
{
    ...
    protected:
         ...
         */
        std::shared_ptr< FilePositionType > setAndGetFilePosition(
            Writable * writable,
            bool write = true
        );
         ...
         * @return The current file position.
         */
        virtual std::shared_ptr< FilePositionType > setAndGetFilePosition(
            Writable * writable,
            std::string extend
        );
        ...
        extendFilePosition( std::shared_ptr< FilePositionType > const &, std::string ) = 0;
    };

    template< typename FilePositionType >
    AbstractIOHandlerImplCommon< FilePositionType >::AbstractIOHandlerImplCommon( AbstractIOHandler * handler )
        :
    ...
    template< typename FilePositionType >
    AbstractIOHandlerImplCommon< FilePositionType >::~AbstractIOHandlerImplCommon( ) = default;
    ...
    std::tuple<
        ...
        bool
    >
    AbstractIOHandlerImplCommon< FilePositionType >::getPossiblyExisting( std::string file )
    {
    ...
    template< typename FilePositionType >
    std::string
    AbstractIOHandlerImplCommon< FilePositionType >::fullPath( InvalidatableFile fileName )
    {
    ...
    template< typename FilePositionType >
    InvalidatableFile
    AbstractIOHandlerImplCommon< FilePositionType >::refreshFileFromParent( Writable * writable )
    {
        if( writable->parent )
        {
            auto
