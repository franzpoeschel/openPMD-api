...
#define OPENPMD_TEMPLATE_OPERATOR template operator
    ...
    )
    {
        ...
        {
            case Datatype::CHAR:
                return action.OPENPMD_TEMPLATE_OPERATOR()< char >( std::forward< Args >( args )... );
            case Datatype::UCHAR:
                return action.OPENPMD_TEMPLATE_OPERATOR()< unsigned char >( std::forward< Args >( args )... );
            case Datatype::SHORT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< short >( std::forward< Args >( args )... );
            case Datatype::INT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< int >( std::forward< Args >( args )... );
            case Datatype::LONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< long >( std::forward< Args >( args )... );
            case Datatype::LONGLONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< long long >( std::forward< Args >( args )... );
            case Datatype::USHORT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< unsigned short >( std::forward< Args >( args )... );
            case Datatype::UINT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< unsigned int >( std::forward< Args >( args )... );
            case Datatype::ULONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< unsigned long >( std::forward< Args >( args )... );
            case Datatype::ULONGLONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< unsigned long long >( std::forward< Args >( args )... );
            case Datatype::FLOAT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< float >( std::forward< Args >( args )... );
            case Datatype::DOUBLE:
                return action.OPENPMD_TEMPLATE_OPERATOR()< double >( std::forward< Args >( args )... );
            case Datatype::LONG_DOUBLE:
                return action.OPENPMD_TEMPLATE_OPERATOR()< long double >( std::forward< Args >( args )... );
            case Datatype::STRING:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::string >( std::forward< Args >( args )... );
            case Datatype::VEC_CHAR:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< char>>( std::forward< Args >( args )... );
            case Datatype::VEC_SHORT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< short>>( std::forward< Args >( args )... );
            case Datatype::VEC_INT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< int>>( std::forward< Args >( args )... );
            case Datatype::VEC_LONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< long>>( std::forward< Args >( args )... );
            case Datatype::VEC_LONGLONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< long long>>( std::forward< Args >( args )... );
            case Datatype::VEC_UCHAR:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< unsigned char>>( std::forward< Args >( args )... );
            case Datatype::VEC_USHORT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< unsigned short>>( std::forward< Args >( args )... );
            case Datatype::VEC_UINT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< unsigned int>>( std::forward< Args >( args )... );
            case Datatype::VEC_ULONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< unsigned long>>( std::forward< Args >( args )... );
            case Datatype::VEC_ULONGLONG:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< unsigned long long>>( std::forward< Args >( args )... );
            case Datatype::VEC_FLOAT:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< float>>( std::forward< Args >( args )... );
            case Datatype::VEC_DOUBLE:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< double>>( std::forward< Args >( args )... );
            case Datatype::VEC_LONG_DOUBLE:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< long double>>( std::forward< Args >( args )... );
            case Datatype::VEC_STRING:
                return action.OPENPMD_TEMPLATE_OPERATOR()< std::vector< std::string>>( std::forward< Args >( args )... );
            ...
            case Datatype::BOOL:
                return action.OPENPMD_TEMPLATE_OPERATOR()< bool >( std::forward< Args >( args )... );
            case Datatype::DATATYPE:
                return action.OPENPMD_TEMPLATE_OPERATOR()< 1000 >( std::forward< Args >( args )... );
            case Datatype::UNDEFINED:
                return action.OPENPMD_TEMPLATE_OPERATOR()< 0 >( std::forward< Args >( args )... );
            default:
