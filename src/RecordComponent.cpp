    ...
    internal::LoadStoreConfigWithBuffer cfg)
{
     ...
     */
    if (dtype_requested != getDatatype() && !constant())
        if (!isSameInteger(dtype_requested, getDatatype()) &&
            !isSameFloatingPoint(dtype_requested, getDatatype()) &&
            !isSameComplexFloatingPoint(dtype_requested, getDatatype()) &&
            !isSameChar(dtype_requested, getDatatype()))
        {
