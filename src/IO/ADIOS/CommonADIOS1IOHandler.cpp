...
void CommonADIOS1IOHandlerImpl<ChildClass>::close(int64_t fd)
{
    int status;
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::close(ADIOS_FILE *f)
{
    int status;
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::flush_attribute(
...
static std::optional<std::string> datasetTransform(json::TracingJSON config)
{
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::extendDataset(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::closeFile(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::availableChunks(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::openPath(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::openDataset(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::deletePath(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::deleteDataset(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::deleteAttribute(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::readDataset(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::readAttribute(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::listPaths(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::listDatasets(
...
template <typename ChildClass>
void CommonADIOS1IOHandlerImpl<ChildClass>::listAttributes(
